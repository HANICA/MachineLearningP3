...
print("Values for exercised_stock_options")
eso = [item["exercised_stock_options"] for key,item in data_dict.items() if item["exercised_stock_options"] != "NaN"]
print("Min: " + str(min(eso)))
print("Max: " + str(max(eso)))
